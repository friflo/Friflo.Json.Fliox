...
namespace Friflo.Json.Tests.Common.UnitTest.Fliox.Client.Happy
{
    public class TestEntityKey
    {
        ...
        private static async Task AssertEntityKey() {
            ...
            using (var database     = new FileDatabase(CommonUtils.GetBasePath() + "assets~/DB/EntityIdStore", "EntityIdStore")) {
        ...
        private static async Task AssertEntityKeyLoopback() {
            using (var _            = Pools.SharedPools) // for LeakTestsFixture
            using (var typeStore    = new TypeStore())
            using (var fileDatabase = new FileDatabase(CommonUtils.GetBasePath() + "assets~/DB/EntityIdStore", "EntityIdStore"))
