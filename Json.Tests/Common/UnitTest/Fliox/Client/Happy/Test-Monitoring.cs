...
namespace Friflo.Json.Tests.Common.UnitTest.Fliox.Client.Happy
{
    public partial class TestStore
    {
        ...
        private static void AssertResult(MonitorResult result) {
            ...
            AreEqual("{'id':'poc-admin','clients':['poc-client'],'counts':[{'db':'default_db','requests':1,'tasks':2}]}", pocAdmin);
            ...
            AreEqual("{'id':'poc-client','user':'poc-admin','counts':[{'db':'default_db','requests':1,'tasks':2}]}", pocClientInfo);
