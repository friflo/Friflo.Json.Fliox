...
namespace Friflo.Json.Tests.Common.UnitTest.Fliox.Client
{
    public class TestUtils
    {
        ...
        public void BenchmarkCreateClient() {
            ...
            var expected    = isWindows ? 2048 : 2048;  // Test Windows & Linux
        ...
        public async Task TestMemorySync() {
            ...
            var expected    = IsDebug() ? 1032 : 744;  // Test Debug & Release
            AreEqual(expected, diff);
        }
        ...
        public async Task TestMemorySyncRead() {
            ...
            var diff = GC.GetAllocatedBytesForCurrentThread() - start;
            var expected = IsDebug() ? Is.InRange(34280, 34280) : Is.InRange(31256, 31256); // Test Debug & Release
            That(diff, expected);
        }
