...
namespace Friflo.Json.Tests.Common.UnitTest.Mapper
{
    ...
    public class TestApi
    {
        ...
        private void AssertReaderBytes(IJsonReader read) {
        ...
        private void AssertWriterBytes(IJsonWriter write) {
        ...
        private void AssertReaderStream(IJsonReader read) {
            // --- Read ---
        ...
        private void AssertWriterString(IJsonWriter write) {
            // --- Write ---
