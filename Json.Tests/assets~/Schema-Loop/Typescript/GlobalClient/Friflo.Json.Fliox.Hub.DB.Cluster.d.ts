...
import { JsonTable } from "./Standard";
...
/** Used to execute raw SQL commands */
export class RawSql {
    /** An SQL statement like: select * from table_name; */
    command  : string;
    /** If true the response contains the schema **columns** in the response */
    schema?  : boolean | null;
}
