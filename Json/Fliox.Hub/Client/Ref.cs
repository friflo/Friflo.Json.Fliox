...
namespace Friflo.Json.Fliox.Hub.Client
{
    ...
    public struct Ref<TKey, T>  where T : class
    {
        ...
        internal static readonly     KeyConverter<TKey>       KeyConvert = KeyConverter.GetRefKey<TKey>();
        ...
        /// not yet resolved. To resolve the referenced entity call <see cref="FlioxClient.SyncTasks"/>.</exception>
        public T Entity {
            get {
                if (peer == null) {
