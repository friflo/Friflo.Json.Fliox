                ...
                try {
                    ...
                    _ = Task.Run(async () => {
                        try {
                            ...
                            var response = await HttpListenerUtils.HandleContext(ctx, hostHub).ConfigureAwait(false); // handle incoming requests parallel
                            
                            await HttpListenerUtils.HandleContextResponse(ctx, response).ConfigureAwait(false);
                        }
                        catch (Exception e) {
