...
{
    static class Gen_SendMessageRight
    {
        private const int Gen_description = 0;
        private const int Gen_database = 1;
        private const int Gen_names = 2;

        private static bool ReadField (ref SendMessageRight obj, PropField field, ref Reader reader) {
            bool success;
        ...
        private static void Write(ref SendMessageRight obj, PropField[] fields, ref Writer writer, ref bool firstMember) {
