...
namespace Friflo.Json.Burst.Math
{
    ...
    {
        // --------------------------------------- vectors ----------------------------------------------
        public static void MemberFloat2(this ref Utf8JsonWriter s, in Str32 key, in float2 value) {
        ...
        public static void MemberFloat3(this ref Utf8JsonWriter s, in Str32 key, in float3 value) {
            s.MemberArrayStart(key, false);
        ...
        public static void MemberFloat4(this ref Utf8JsonWriter s, in Str32 key, in float4 value) {
            s.MemberArrayStart(key, false);
        ...
        public static void MemberFloat2x2(this ref Utf8JsonWriter s, in Str32 key, in float2x2 value) {
        ...
        public static void MemberFloat2x3(this ref Utf8JsonWriter s, in Str32 key, in float2x3 value) {
            s.MemberArrayStart(key, true);
            ArrayFloat2(ref s, in value.c0);
            ArrayFloat2(ref s, in value.c1);
        ...
        public static void MemberFloat2x4(this ref Utf8JsonWriter s, in Str32 key, in float2x4 value) {
            s.MemberArrayStart(key, true);
            ArrayFloat2(ref s, in value.c0);
            ArrayFloat2(ref s, in value.c1);
            ArrayFloat2(ref s, in value.c2);
        ...
        public static void MemberFloat3x2(this ref Utf8JsonWriter s, in Str32 key, in float3x2 value) {
            s.MemberArrayStart(key, true);
        ...
        public static void MemberFloat3x3(this ref Utf8JsonWriter s, in Str32 key, in float3x3 value) {
            s.MemberArrayStart(key, true);
            ArrayFloat3(ref s, in value.c0);
            ArrayFloat3(ref s, in value.c1);
        ...
        public static void MemberFloat3x4(this ref Utf8JsonWriter s, in Str32 key, in float3x4 value) {
            s.MemberArrayStart(key, true);
            ArrayFloat3(ref s, in value.c0);
            ArrayFloat3(ref s, in value.c1);
            ArrayFloat3(ref s, in value.c2);
        ...
        public static void MemberFloat4x2(this ref Utf8JsonWriter s, in Str32 key, in float4x2 value) {
            s.MemberArrayStart(key, true);
        ...
        public static void MemberFloat4x3(this ref Utf8JsonWriter s, in Str32 key, in float4x3 value) {
            s.MemberArrayStart(key, true);
            ArrayFloat4(ref s, in value.c0);
            ArrayFloat4(ref s, in value.c1);
        ...
        public static void MemberFloat4x4(this ref Utf8JsonWriter s, in Str32 key, in float4x4 value) {
            s.MemberArrayStart(key, true);
            ArrayFloat4(ref s, in value.c0);
            ArrayFloat4(ref s, in value.c1);
            ArrayFloat4(ref s, in value.c2);
