...
{
    internal class RefKeyGuidField<T> : RefKey<Guid, T> where T : class {
        ...
        internal RefKeyGuidField(FieldInfo field) {
            this.field  = field;
    ...
    internal class RefKeyGuidProperty<T> : RefKey<Guid, T> where T : class {
        ...
        internal RefKeyGuidProperty(PropertyInfo property, MethodInfo idGetMethod, MethodInfo idSetMethod) {
