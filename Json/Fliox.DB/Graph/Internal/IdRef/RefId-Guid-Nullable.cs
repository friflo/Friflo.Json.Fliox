...
{
    internal class RefKeyGuidNullField<T> : RefKey<Guid?, T> where T : class {
        ...
        internal RefKeyGuidNullField(FieldInfo field) {
            this.field  = field;
    ...
    internal class RefKeyGuidNullProperty<T> : RefKey<Guid?, T> where T : class {
        ...
        internal RefKeyGuidNullProperty(PropertyInfo property, MethodInfo idGetMethod, MethodInfo idSetMethod) {
