...
namespace Friflo.Json.Flow.Schema
{
    ...
    public class Generator
    {
        ...
        private  readonly   ICollection<Replacement>        stripNamespaces;
        ...
        public Generator (
            ...
            ICollection<Replacement>    stripNamespaces = null,
            ...
            Func<TypeDef, string>       getPath = null)
        {
            ...
            types                   = schema.Types;
            this.stripNamespaces    = stripNamespaces   ?? new List<Replacement>();
        ...
        private string Strip (string ns) {
            ns  = ns ?? "default";
            foreach (var replacement in stripNamespaces) {
