...
namespace Friflo.Json.Flow.Schema
{
    ...
    public class Generator
    {
        ...
        public Generator (TypeSchema schema, ICollection<string> stripNamespaces, string fileExtension, Func<TypeDef, string> getPackageName = null) {
            this.schema             = schema;
            fileExt                 = fileExtension;
            types                   = schema.Types;
            this.stripNamespaces    = stripNamespaces       ?? new List<string>();
            separateTypes           = schema.SeparateTypes  ?? new List<TypeDef>();
            getPackageName          = getPackageName        ?? GetPackageNameCallback;
            foreach (var type in types) {
                var packageName     = getPackageName(type);
