...
namespace Friflo.Json.Flow.Schema
{
    ...
    public class Generator
    {
        ...
        public Generator (TypeSchema schema, string fileExtension, ICollection<TypeDef> separateTypes, ICollection<string> stripNamespaces, Func<TypeDef, string> getPath = null) {
            this.schema             = schema;
