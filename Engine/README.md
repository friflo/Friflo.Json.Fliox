...
<img src="docs/images/entity-debugger.png" width="714" height="422"></img>  
*Screenshot:* Entity properties in debugger - showing its state and enables browsing the entire store hierarchy.
