...
public static class Test_Unresolved
{
    ...
    public static void Test_Unresolved_components()
    {
        ...
        for (int n = 0; n < 2; n++)
        {
            var gameEntity  = converter.DataEntityToEntity(source1, store, out _);
            ...
            var targetEntity = converter.EntityToDataEntity(gameEntity);
        ...
        for (int n = 0; n < 2; n++)
        {
            var gameEntity  = converter.DataEntityToEntity(source2, store, out _);
            var unresolved  = gameEntity.GetComponent<Unresolved>();
