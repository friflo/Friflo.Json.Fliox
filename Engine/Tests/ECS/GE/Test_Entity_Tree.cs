...
[Test]
    public static void Test_InsertChild() {
        ...
        var child5 = store.CreateEntity(5);
        {
            ...
            SetHandler(store, args => AreEqual("entity: 1 - Add ChildIds[0] = 5", args.ToString()));
    ...
    public static void Test_AddChild_move_root_tree_entity() {
        ...
        SetHandler(store, args => AreEqual("entity: 2 - Add ChildIds[0] = 4", args.ToString()));
        child1.AddChild(subChild);
        SetHandler(store, args => AreEqual("entity: 1 - Add ChildIds[1] = 3", args.ToString()));
        root.AddChild(child2);
    ...
    public static void Test_RemoveChild() {
        ...
        // --- remove child
        SetHandler(store, args => AreEqual("entity: 1 - Remove ChildIds[0] = 2",  args.ToString()));
    ...
    public static void Test_RemoveChild_from_multiple_children() {
        ...
        SetHandler(store, args => AreEqual("entity: 1 - Add ChildIds[1] = 3",     args.ToString()));
        root.AddChild(child3);
        SetHandler(store, args => AreEqual("entity: 1 - Add ChildIds[2] = 4",     args.ToString()));
    ...
    public static void Test_DeleteEntity()
    {
        ...
        SetHandler(store, args => AreEqual("entity: 2 - Add ChildIds[0] = 3", args.ToString()));
