...
#region get component type indexes
    ...
    internal static Span<int> GetTypes<T1, T2, T3, T4, T5, T6>(Span<int> components)
        where T1 : struct, IComponent
        where T2 : struct, IComponent
        where T3 : struct, IComponent
        where T4 : struct, IComponent
        ...
        where T6 : struct, IComponent
    {
        ...
        components[3] = StructHeap<T4>.StructIndex;
        components[4] = StructHeap<T5>.StructIndex;
        components[5] = StructHeap<T6>.StructIndex;
        return components;
    }
    
    internal static Span<int> GetTypes<T1, T2, T3, T4, T5, T6, T7>(Span<int> components)
        where T1 : struct, IComponent
        where T2 : struct, IComponent
        where T3 : struct, IComponent
        where T4 : struct, IComponent
        ...
        where T7 : struct, IComponent
    {
        ...
        components[4] = StructHeap<T5>.StructIndex;
        components[5] = StructHeap<T6>.StructIndex;
        components[6] = StructHeap<T7>.StructIndex;
        return components;
    }
    
    internal static Span<int> GetTypes<T1, T2, T3, T4, T5, T6, T7, T8>(Span<int> components)
        where T1 : struct, IComponent
        where T2 : struct, IComponent
        where T3 : struct, IComponent
        where T4 : struct, IComponent
        ...
        where T8 : struct, IComponent
    {
        ...
        components[5] = StructHeap<T6>.StructIndex;
        components[6] = StructHeap<T7>.StructIndex;
        components[7] = StructHeap<T8>.StructIndex;
        return components;
    }
    
    internal static Span<int> GetTypes<T1, T2, T3, T4, T5, T6, T7, T8, T9>(Span<int> components)
        where T1 : struct, IComponent
        where T2 : struct, IComponent
        where T3 : struct, IComponent
        where T4 : struct, IComponent
        ...
        where T9 : struct, IComponent
    {
        ...
        components[6] = StructHeap<T7>.StructIndex;
        components[7] = StructHeap<T8>.StructIndex;
        components[8] = StructHeap<T9>.StructIndex;
        return components;
    }
    
    internal static Span<int> GetTypes<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(Span<int> components)
        where T1 : struct, IComponent
        where T2 : struct, IComponent
        where T3 : struct, IComponent
        where T4 : struct, IComponent
        ...
        where T10: struct, IComponent
    {
        ...
        components[7] = StructHeap<T8>.StructIndex;
        components[8] = StructHeap<T9>.StructIndex;
        components[9] = StructHeap<T10>.StructIndex;
        return components;
    }
    #endregion
