...
public static partial class EntityExtensions
{
        ...
        where T1 : struct, IComponent
    {
        ...
        var heap1 = heapMap[StructHeap<T1>.StructIndex];
        ...
        where T2 : struct, IComponent
    {
        var heapMap = archetype.heapMap;
        var heap1 = heapMap[StructHeap<T1>.StructIndex];
        var heap2 = heapMap[StructHeap<T2>.StructIndex];
        if (heap1 == null ||
            heap2 == null) {
            return false;
        }
        ...
        where T3 : struct, IComponent
    {
        ...
        var heap1 = heapMap[StructHeap<T1>.StructIndex];
        var heap2 = heapMap[StructHeap<T2>.StructIndex];
        var heap3 = heapMap[StructHeap<T3>.StructIndex];
        if (heap1 == null ||
            heap2 == null ||
            heap3 == null) {
            return false;
        ...
        where T4 : struct, IComponent
    {
        ...
        var heap2 = heapMap[StructHeap<T2>.StructIndex];
        var heap3 = heapMap[StructHeap<T3>.StructIndex];
        var heap4 = heapMap[StructHeap<T4>.StructIndex];
        if (heap1 == null ||
            heap2 == null ||
            heap3 == null ||
            heap4 == null) {
        ...
        where T5 : struct, IComponent
    {
        ...
        var heap3 = heapMap[StructHeap<T3>.StructIndex];
        var heap4 = heapMap[StructHeap<T4>.StructIndex];
        var heap5 = heapMap[StructHeap<T5>.StructIndex];
        if (heap1 == null ||
            heap2 == null ||
            heap3 == null ||
            heap4 == null ||
        ...
        where T6 : struct, IComponent
    {
        ...
        var heap4 = heapMap[StructHeap<T4>.StructIndex];
        var heap5 = heapMap[StructHeap<T5>.StructIndex];
        var heap6 = heapMap[StructHeap<T6>.StructIndex];
        if (heap1 == null ||
            heap2 == null ||
            heap3 == null ||
            heap4 == null ||
        ...
        where T7 : struct, IComponent
    {
        ...
        var heap5 = heapMap[StructHeap<T5>.StructIndex];
        var heap6 = heapMap[StructHeap<T6>.StructIndex];
        var heap7 = heapMap[StructHeap<T7>.StructIndex];
        if (heap1 == null ||
            heap2 == null ||
            heap3 == null ||
            heap4 == null ||
        ...
        where T8 : struct, IComponent
    {
        ...
        var heap6 = heapMap[StructHeap<T6>.StructIndex];
        var heap7 = heapMap[StructHeap<T7>.StructIndex];
        var heap8 = heapMap[StructHeap<T8>.StructIndex];
        if (heap1 == null ||
            heap2 == null ||
            heap3 == null ||
            heap4 == null ||
        ...
        where T9 : struct, IComponent
    {
        ...
        var heap7 = heapMap[StructHeap<T7>.StructIndex];
        var heap8 = heapMap[StructHeap<T8>.StructIndex];
        var heap9 = heapMap[StructHeap<T9>.StructIndex];
        if (heap1 == null ||
            heap2 == null ||
            heap3 == null ||
            heap4 == null ||
        ...
        where T10: struct, IComponent
    {
        ...
        var heap8 = heapMap[StructHeap<T8>.StructIndex];
        var heap9 = heapMap[StructHeap<T9>.StructIndex];
        var heap10= heapMap[StructHeap<T10>.StructIndex];
        if (heap1 == null ||
            heap2 == null ||
            heap3 == null ||
            heap4 == null ||
