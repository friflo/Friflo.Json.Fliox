    ...
    where T2 : struct, IComponent
{
    ...
    internal QueryChunksOld(ArchetypeQuery<T1, T2> query) {
        this.query = query;
    }
    ...
    IEnumerable<(Chunk<T1>, Chunk<T2>, ChunkEntities)>.GetEnumerator() => new ChunkEnumeratorOld<T1, T2> (query);
    
    // --- IEnumerable
    [ExcludeFromCodeCoverage]
    IEnumerator     IEnumerable.GetEnumerator() => new ChunkEnumeratorOld<T1, T2> (query);
    ...
    where T2 : struct, IComponent
{
    ...
    internal  ChunkEnumeratorOld(ArchetypeQuery<T1, T2> query)
    {
        copyT1          = query.copyT1;
        copyT2          = query.copyT2;
