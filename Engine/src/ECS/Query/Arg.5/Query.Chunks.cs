    ...
    where T5 : struct, IComponent
{
    ...
    public bool MoveNext()
    {
        ...
        var chunks3     = (StructHeap<T3>)heapMap[structIndex3].heap;
        var chunks4     = (StructHeap<T4>)heapMap[structIndex4].heap;
        var chunks5     = (StructHeap<T5>)heapMap[structIndex5].heap;
