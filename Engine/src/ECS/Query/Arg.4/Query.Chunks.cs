...
public readonly struct QueryChunks<T1, T2, T3, T4>  : IEnumerable <(Chunk<T1>, Chunk<T2>, Chunk<T3>, Chunk<T4>, ChunkEntities)>
    ...
    where T4 : struct, IComponent
{
    ...
    // --- IEnumerable<>
    IEnumerator<(Chunk<T1>, Chunk<T2>, Chunk<T3>, Chunk<T4>, ChunkEntities)>
    IEnumerable<(Chunk<T1>, Chunk<T2>, Chunk<T3>, Chunk<T4>, ChunkEntities)>.GetEnumerator() => new ChunkEnumerator<T1, T2, T3, T4> (query);
    ...
    where T4 : struct, IComponent
{
    ...
    private readonly    (Chunk<T1>, Chunk<T2>, Chunk<T3>, Chunk<T4>, ChunkEntities)[]   chunks; //  8
    ...
    {
        this.query      = query;
        var chunkArrays = query.chunkArrays ?? new Stack<(Chunk<T1>, Chunk<T2>, Chunk<T3>, Chunk<T4>, ChunkEntities)[]>();
        ...
        chunks ??= new (Chunk<T1>, Chunk<T2>, Chunk<T3>, Chunk<T4>, ChunkEntities)[chunkCount];
        ...
        for (int n = 0; n < archetypes.length; n++)
        {
            ...
            for (int chunkPos = 0; chunkPos <= chunkEnd; chunkPos++)
            {
                ...
                chunks[pos++]       = new ValueTuple<Chunk<T1>, Chunk<T2>, Chunk<T3>, Chunk<T4>, ChunkEntities>(chunk1, chunk2, chunk3, chunk4, entities);
            }
        }
        last    = pos - 1;
        index   = -1;
    ...
    // --- IEnumerator<>
    public readonly (Chunk<T1>, Chunk<T2>, Chunk<T3>, Chunk<T4>, ChunkEntities) Current => chunks[index];
