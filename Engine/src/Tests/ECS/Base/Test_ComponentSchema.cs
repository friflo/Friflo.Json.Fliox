...
public static class Test_ComponentSchema
{
    ...
    public static void Test_ComponentTypes()
    {
        ...
        AreEqual("components: 58  scripts: 10  entity tags: 15", schema.ToString());
        AreEqual(59,    components.Length);
        AreEqual(11,    scripts.Length);
        
        AreEqual(64,    schema.SchemaTypeByKey.Count);
        AreEqual(58,    schema.ComponentTypeByType.Count);
