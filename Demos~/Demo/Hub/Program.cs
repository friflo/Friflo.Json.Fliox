...
namespace DemoHub
{
    ...
    internal  static class  Program
    {
        ...
        internal static async Task<HttpHost> CreateHttpHost()
        {
            ...
            var userDB              = new FileDatabase("user_db", "../Test/DB/user_db") { Service = new UserDBService(), Schema = UserDB.Schema, Pretty = false };
        ...
        {
            var fileDb = new FileDatabase("main_db", "../Test/DB/main_db") { Service = service, Schema = schema };
            if (!UseMemoryDbClone)
                return fileDb;
            ...
            var memoryDB = new MemoryDatabase("main_db") { Service = service, Schema = schema };
